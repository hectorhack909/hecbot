...
|
|- *!menu 0* -> Ver nformacion ℹ️
|- *!menu 1* -> Crear stickers ➕
|- *!menu 2* -> Ver utilidades 🔗 
|- *!menu 3* -> Descargar algo ⬇️
|- *!menu 4* -> Ajustes de grupo 🛠️
|- *!menu 5* -> Diversión 🎈 
|- *!menu 6* -> Créditos ❤️
|
...
|>---- ☾ 🖼️ *FIGURINHAS* 🖼️☽
|
|- *!s* - Transforma una IMAGEN en una pegatina. 🏙️
|- *!s* 1 - Transforma una IMAGEN en una pegatina circular. 🌆
|- *!sgif* - Convierte un VIDEO/GIF en una pegatina. 🎬
|- *!sgif* 1 - Convierte un VIDEO/GIF en una pegatina (sin cortar).🎬
|- *!sgif* 2 - Transforma un VIDEO/GIF en una pegatina circular.🎬
|- *!simg* - Transforma una PEGATINA en una foto. 🏙️
|- *!tps* - Convierte un TEXTO en una pegatina. 🅰️
|- *!atps* - Convierte un TEXTO en una pegatina animada. 🌪️
|- *!ssf* - Transforma una IMAGEN en una pegatina sin fondo. 🌆
|
╰╼❥ ${process.env.NOME_BOT.trim()}® by *${process.env.NOME_ADMINISTRADOR.trim()}*`
    },
...
|- *!report* Informar un problema al propietario. 🙎
|- *!mydata* - Muestra tus datos de uso. ⬆️⬇️
|
╰╼❥ ${process.env.NOME_BOT.trim()}® by *${process.env.NOME_ADMINISTRADOR.trim()}*`
    },
...
|>---- ☾ 📥 *DOWNLOADS* 📥☽
|
|- [ *!play y el nombre de la canción* 🎶] - Descarga una canción y envíala.
|- [ *!yt y el nombre del video* 🎬] - Descarga un video de YouTube y lo envía.
|- [ *!fb y el link link del post* 📎] - Descarga un vídeo de Facebook y envíalo.
|- [ *!ig y el link del post* 📎] - Descarga un vídeo/foto de Instagram y envíalo.
|- [ *!tw y el link del tweet* 🐦] - Descarga un vídeo/foto de Twitter y envíalo.
|- [ *!tk y el link del video* 🎬] - Descarga un vídeo de Tiktok y envíalo.
|- [ *!img y el link de la imagen* 📎] - Descarga una imagen y la envía
|
╰╼❥ ${process.env.NOME_BOT.trim()}® by *${process.env.NOME_ADMINISTRADOR.trim()}*`
    },
...
Creador del Bot : HéctorHack

Creador del servidor Open-WA : Mohammed Shah
